...
//		}
//		if(num) {
//			System.out.println("이것도 잘못된 조건시입니다.");
//		}
		...
		/*
		if(조건식); => 조건식에 상관없이 다음 문장이 실행된는 형태로
		...
		/*
		System.in.read()
			: 사용저애개 하나의 문자를 입력받을때 사용하는 메소드로
			입력한 문자의 아스키코드값을 반환한다.
			해당 함수는 기본적으로 IOExceotion 예외를 가지고 있어서
			무시하기 위해 main()함수에서 throws한다.
		 */
		...
		*/
		...
		/*
		문자는 내부적으로 아스키코드로 저장되므로 아래와 같은 비교연산이
		가능하다. 또한 산술연산도 가능하다.
		 */
		//아스키코드값을 모를 때
