...
public class Array01_1 {
	...
	public static void main(String[] args) {
		...
		할당받게된다.
		 */
		//크기가 3인 int형 배열선언이므로 index는 0~2까지의 생성된다.
		int[] numArr = new int[3];
		numArr[0] = 10;
		numArr[1] = 20;
		numArr[2] = 30;
		
		//생성된 배열의 메모리 참조값이 출력된다.
		...
		/*
		배열의 선언 및 초기화
			ㅣ 배열은 여려개의 변수를 사용하기 위해 선언하므로,
			졉근을 위해 일반적으로 반복문을 사용하게된다.
			
		배열명.length => 해당배열의 크기가 반환된다. 아래의 경우 4가 반환됨.
		 */
		...
		/*
		배열의 선언과 동시에 초기화를 하는 경우 자바 컴파일러는 초기값의
		갯수를 통해 크기를 결정할 수 있으므로 이런경우 크기는 생략하도록
		약속되어있다
		 */
		//int[] initArr2 = new int[3] {1, 20, 300}; //에러방생
