...
[메소드형식3]
	매개변수는 있으나 반환값은 없는경우.
	메소드 실행을 위한 값을 전달받은후 연산의 결과를 반환하지 않고
	콘솔에 즉시 출력하는 형태의 프로그램에 주로 사용됨.
 */

public class MethodType03_1 {
	/*
	시나리오] 사용자가 입력한2개의 시작값과 끝값사이에 있는 
	...
	static void yesParamNoReturn(int startNum, int endNum) {
		...
		/*
		1에서 10까지 더하는 프로드램의 시작값과 종료값만
		변수로 변경하여, 해당 구간의 합을 구하는 프로그램으로 업데이트.
		 */
